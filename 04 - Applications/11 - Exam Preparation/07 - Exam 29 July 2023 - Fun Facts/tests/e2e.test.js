...
describe("E2E tests", function () {
    ...
    describe('BONUS: Likes [ 15 Points ]', async () => {
        it("Likes for guests calls correct API and shows correct info [ 2.5 Points ]", async function () {
            ...
            const { get: userLikes } = await handle(endpoints.userLikes(data._id));
            ...
            expect(userLikesIsHandled()).to.equal(false, 'User Likes API was called incorrectly for a guest user');
        });
