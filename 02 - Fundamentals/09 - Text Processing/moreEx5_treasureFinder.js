function treasureFinder(input) {
    ...
    input.forEach(string => {
        ...
        let type = treasure.substring(treasure.indexOf('&') + 1, treasure.indexOf('&', treasure.indexOf('&') + 1));
        let coordinates = treasure.substring(treasure.indexOf('<') + 1, treasure.indexOf('>'));
